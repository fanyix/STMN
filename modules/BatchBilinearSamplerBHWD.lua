...
function layer:updateOutput(input)
  ...
  self.inputImageView = self.inputImageView or inputImages.new()
  self.inputImageView:resize(B, H, W, C)
  self.inputImageView:zero()
  self.inputImageView:copy(addOuterDim(inputImages):expand(B, H, W, C))
