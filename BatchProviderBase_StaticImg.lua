...
local BatchProviderBase_StaticImg = torch.class('fbcoco.BatchProviderBase_StaticImg')

function BatchProviderBase_StaticImg:getImages(img_ids, do_flip)
...
function BatchProviderBase_StaticImg.takeSubset(rec, t, i, is_bg)
...
function BatchProviderBase_StaticImg.selectBBoxesOne(bboxes, num_max, im_scale, im_size, flip)
   local rois = {}
   local labels = {}
   local gtboxes = {}
